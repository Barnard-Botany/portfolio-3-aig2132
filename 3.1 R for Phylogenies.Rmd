...
After I pasted these few commands I got information about the tip labels, and what information is available from the tree that I just made. So the code tells me that in this tree I have the class of "phylo " and order given by "cladewise"
...
```{r}
newick_str = "(Clubmosses,(Ferns,(Ginko, Daisy)));"
tr2_plants = read.tree(text=newick_str)
plot(tr2_plants)
...
The Phylogenetic tree with 6 tips and 5 internal nodes do not have any branch lengths because I have not told it what and how to seperate it. What I noticed about the erroneous tree is that R does not discriminate in the commands that you give it. Let's say that in my erroneous we placed the outgroup in the ingroup there is no way of R telling me that this is wrong given the construction of the phylogenic tree. 

```{r}

newick_str = "(Clubmosses, (Sequoia,(Ferns,(Ginko, (Daisy, Radish)))));"
tr2_plants = read.tree(text=newick_str)
plot(tr2_plants)

tr2_plants
str("tr2_plants")
attributes(tr2_plants)
names(tr2_plants) 

#now I will be writting the erroneous tree where I will place the outgroup Clubmoses into the ingroup 
newick_str1 = "(Daisy, (Sequoia,(Ferns,(Ginko, (Clubmosses, Radish)))));"
tr3_plants = read.tree(text=newick_str1)
plot(tr3_plants)

tr3_plants
str("tr3_plants")
attributes(tr3_plants)
names(tr3_plants)
```
...
The lenghts of the tree was added to the tree meaning that more information of nodes were added making the tree more insightful of relative time of diversion. 
...
```{r}
newick_str = "(Clubmosses,(Ferns,(Ginko,(Sequoia,(Daisy, Radish)))));"
tr2_plants = read.tree(text=newick_str)
plot(tr2_plants)

plot(tr2_plants, type="phylogram")
plot(tr2_plants, type="cladogram")
plot(tr2_plants, type="fan")
plot(tr2_plants, type="unrooted")
plot(tr2_plants, type="radial")

plot(tr2_plants, main = "normal")
plot(ladderize(tr2_plants), main = "right-ladderized")
plot(ladderize(tr2_plants, FALSE), main = "left-ladderized")

plot(tr2_plants, main = "normal", type = "phylogram", direction = c("upwards"))
plot(ladderize(tr2_plants), main = "right-ladderized", direction = c("upwards"))
plot(ladderize(tr2_plants, FALSE), main = "left-ladderized", direction=c("upwards"))
...
Most noticibly there is a shaper difference between both of the trees. This means that the same information is used in both pairs of trees. 
...
```{r}
#List One 
EG2<-c("Abies balsamea","Acer rubrum","Panicum depauperatum", "Erigeron strigosus","Parthenocissus quinquefolia","Prunus serotina","Smilax rotundifolia","Viburnum prunifolium","Viola cucullata","Castanea dentata","Eurybia divaricata", "Quercus rubra","Rhus copallinum","Rubus allegheniensis","Viburnum acerifolium","Muhlenbergia schreberi","Boechera laevigata","Aralia nudicaulis","Arisaema triphyllum","Asclepias tuberosa","Aureolaria flava","Carex umbellata","Cuscuta gronovii","Desmodium nudiflorum","Erechtites hieraciifolius", "Fragaria virginiana","Galium circaezans","Galium triflorum","Gaylussacia baccata", "Geranium maculatum","Geum virginianum","Hamamelis virginiana","Juniperus virginiana","Kalmia latifolia","Lespedeza procumbens","Linum virginianum")
EG2
tree_phylomatic_EG2 <- phylomatic(taxa = EG2, get = 'POST')
plot(tree_phylomatic_EG2, no.margin = TRUE, type="cladogram")
newick_fn5 = "tree_phylomatic_EG2"
write.tree(tree_phylomatic_EG2, file=newick_fn5) 

#repeating to get tree from Zanne2014
tree_phylomatic_EG3 <- phylomatic(taxa = EG2, storedtree ="zanne2014", get = 'POST')
plot(tree_phylomatic_EG3, no.margin = TRUE, type="cladogram")
newick_fn6 = "tree_phylomatic_EG2"
write.tree(tree_phylomatic_EG3, file=newick_fn6) 

plot(tree_phylomatic_EG3, type="phylogram")
plot(tree_phylomatic_EG3, type="cladogram")
plot(tree_phylomatic_EG3, type="fan")
plot(tree_phylomatic_EG3, type="unrooted")
plot(tree_phylomatic_EG3, type="radial")

plot(tree_phylomatic_EG3, main = "normal")
plot(ladderize(tree_phylomatic_EG3), main = "right-ladderized")
plot(ladderize(tree_phylomatic_EG3, FALSE), main = "left-ladderized")

```
Abby: 
List one comes from Porfolio 2 Plant O Matic data which comes from data of plants that used to be where I reside in Washington Heights.I think the hard part of this part of the assignment was understanding that 
List two comes from Portforlio 2 Wilikia Map data which comes from the app that uses your location to come up with species around you. I think it is very cool that R can modify the list and use the online data from taxa to recollect and make a phylogenetic tree. 

```{r}
#List two 
EG3<-c ( "Abies balsamea","Acalypha australis", "Acalypha burquezii","Acalypha rhomboidea","Acalypha virginica","Acer palmatum","Acer ginnala"," Acer negundo","Acer nigrum", "Acer pensylvanicum","Acer platanoides","Acer pseudoplatanus","Acer rubrum","Acer saccharinum","Acer saccharum","Acorus calamus", "Actaea alba","Actaea pachypoda"," Actaea rubra","Adiantum jordanii","Adiantum pedatum","Adlumia fungosa","Adonis annua","Adonis aestivalis" )

EG3
tree_phylomatic_EG3 <- phylomatic(taxa = EG3, get = 'POST')
plot(tree_phylomatic_EG3, no.margin = TRUE, type="cladogram")
newick_fn7 = "tree_phylomatic_EG3"
write.tree(tree_phylomatic_EG3, file=newick_fn7) 

#repeating to get tree from Zanne2014
tree_phylomatic_EG4 <- phylomatic(taxa = EG3, storedtree ="zanne2014", get = 'POST')
plot(tree_phylomatic_EG4, no.margin = TRUE, type="cladogram")
newick_fn8 = "tree_phylomatic_EG3"
write.tree(tree_phylomatic_EG4, file=newick_fn8) 

plot(tree_phylomatic_EG4, type="phylogram")
plot(tree_phylomatic_EG4, type="cladogram")
plot(tree_phylomatic_EG4, type="fan")
plot(tree_phylomatic_EG4, type="unrooted")
plot(tree_phylomatic_EG4, type="radial")

plot(tree_phylomatic_EG4, main = "normal")
plot(ladderize(tree_phylomatic_EG4), main = "right-ladderized")
plot(ladderize(tree_phylomatic_EG4, FALSE), main = "left-ladderized")
